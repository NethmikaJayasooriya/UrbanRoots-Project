        ...
        builder: (context, setDialogState) {
          return AlertDialog(
            ...
            title: Text("Extra Detail", 
              style: GoogleFonts.poppins(color: AppColors.textMain, fontWeight: FontWeight.bold, fontSize: 22)),
            content: Column(
                ...
                Container(
                  ...
                  child: SwitchListTile(
                    ...
                    title: Text("High Wind Exposure?", 
                      style: GoogleFonts.poppins(color: AppColors.textMain, fontSize: 14, fontWeight: FontWeight.w600)),
            ...
            actions: [
              TextButton(
                ...
                child: Padding(
                  ...
                  child: Text("Next", 
                    style: GoogleFonts.poppins(color: AppColors.primaryGreen, fontWeight: FontWeight.bold, fontSize: 16)),
                ),
              ),
            ],
          );
                ...
                builder: (context, child) {
                  return Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      border: Border.all(
                        color: _isScanning ? AppColors.primaryGreen.withOpacity(0.5) : Colors.transparent, 
                        width: 2
                      ),
                      boxShadow: _isScanning 
                        ? [BoxShadow(color: AppColors.primaryGreen.withOpacity(0.2), blurRadius: 30 * _animationController.value, spreadRadius: 10 * _animationController.value)] 
                        : [],
                    ),
                    child: Center(
                      child: _isScanning
                          ...
                          child: Container(
                            ...
                            child: Row(
                              children: [
                                ...
                                Text(deviceName, style: GoogleFonts.poppins(color: AppColors.textMain, fontSize: 15, fontWeight: FontWeight.w500)),
                                const Spacer(),
