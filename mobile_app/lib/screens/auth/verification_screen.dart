...
import 'reset_password_screen.dart'; // Links to the next screen
                  ...
                  child: Column(
                    children: [
                      Container(
                        ...
                        child: const Icon(Icons.email_outlined, color: neonGreen, size: 40),
                      ),
                ...
                Center(
                  child: RichText(
                    text: TextSpan(
                      ...
                      children: [
                        TextSpan(text: "Resend email", style: GoogleFonts.poppins(color: neonGreen, fontWeight: FontWeight.bold)),
                      ],
                    ),
                  ),
                ),
